...
export default function PedidosPage() {
    ...
    useEffect(() => {
        ...
        api
            ...
            .catch(() => setErro("Nao consegui listar os pedidos."))
    ...
    if (itens.length === 0)
        return <p>Nenhum pedido nesta pagina.</p>;

    return (
        <div>
            <h2>Todos os pedidos</h2>
            <p>
                GET /api/pedidos - pagina {pagina} · total {total}
            </p>
            ...
            <button type="button" disabled={pagina * 10 >= total}
